package com.zvvnmod.meco.translate.letter.from.mw;
 ...
 * TIME  : 17:41
 */
public class FromMWLetterCodeMapper {
    ...
    private static void buildChagh() {
    ...
    private static void buildHundii() {
    ...
    private static void buildSaarmag() {
    ...
    private static Map<String, String> getEhshig() {
        Map<String, String> ehshig = new LinkedHashMap<>();
        //a
        ehshig.put("\u0020\u1820\u0020", "\ue000\ue00c");
        ehshig.put("\u0020\u180e\u1820\u0020", "\ue00d");
        //e
    ...
    private static Map<String, String> getGiiSH() {
        Map<String, String> sh = new LinkedHashMap<>();
        //sh
        sh.put("\u0020\u1831\u0020", "\ue03f");
        //head
        sh.put("\u0020\u1831", "\ue03f");
    ...
    private static Map<String, String> getGiiY() {
        ...
        //top y+180b+a,y+180b+e,y+180b+i,y+180b+o,y+180b+u
        //look "\u0020\u1836\u180b"

        //middle y+180b+a,y+180b+e,y+180b+o,y+180b+u
        y.put("\u1836\u180b\u1820", "\ue006\ue005");
        y.put("\u1836\u180b\u1821", "\ue006\ue005");
        y.put("\u1836\u180b\u1823", "\ue006\ue008");
        y.put("\u1836\u180b\u1824", "\ue006\ue008");
        ...
        //tail y+180b+a,y+180b+e,y+180b+o,y+180b+u
        y.put("\u1836\u180b\u1820\u0020", "\ue006\ue00c");
        y.put("\u1836\u180b\u1821\u0020", "\ue006\ue00c");
        y.put("\u1836\u180b\u1823\u0020", "\ue006\ue011");
        y.put("\u1836\u180b\u1824\u0020", "\ue006\ue011");
    ...
    private static Map<String, String> getGiiKH() {
        Map<String, String> kh = new LinkedHashMap<>();
        //k
        kh.put("\u0020\u183b\u0020", "\ue05c");
        //head
        kh.put("\u0020\u183b", "\ue05c");
    ...
    private static Map<String, String> getGiiHH() {
        Map<String, String> hh = new LinkedHashMap<>();
        //hh
        hh.put("\u0020\u183e\u0020", "\ue000\ue066");
        //head
        hh.put("\u0020\u183e", "\ue000\ue066");
    ...
    private static Map<String, String> getGiiLH() {
        Map<String, String> lha = new LinkedHashMap<>();
        return lha;
    }

    private static Map<String, String> getGiiZHI() {
        Map<String, String> zhi = new LinkedHashMap<>();
        return zhi;
    }

    private static Map<String, String> getGiiCHI() {
        Map<String, String> chi = new LinkedHashMap<>();
        return chi;
    }

    private static Map<String, String> getDagbor() {
        Map<String, String> dagbor = new LinkedHashMap<>();
        //i
        dagbor.put("\u0020\u1822\u180b\u0020", "\ue01a");
        dagbor.put("\u0020\u202f\u1822\u0020", "\u0020\ue01a");
        dagbor.put("\u0020\u1835\u180e", "\ue01a");
    ...
    private static Map<String, String> getDevsger() {
        Map<String, String> devsger = new LinkedHashMap<>();
        //eng
        devsger.put("\u0020\u1829\u0020", "\ue005\ue031");
        devsger.put("\u0020\u1829", "\ue005\ue031");
        devsger.put("\u1829", "\ue005\ue031");
    ...
    private static Map<String, String> whatTheFuck() {
        Map<String, String> fuck = new LinkedHashMap<>();
        //ee
        fuck.put("\u0020\u1827\u0020", "\ue000\ue058");
        //head ee
        fuck.put("\u0020\u1827", "\ue000\ue057");
    ...
    private static void buildWWithEhshig() {
